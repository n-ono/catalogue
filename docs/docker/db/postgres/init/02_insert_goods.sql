insert into basic_fare (destination, amount) values ('shinosaka', 8090);
insert into basic_fare (destination, amount) values ('himeji', 10010);
insert into basic_super_express_surcharge (train_type, seat_type, destination, amount) values ('nozomi', 'free', 'shinosaka', 5280);
insert into basic_super_express_surcharge (train_type, seat_type, destination, amount) values ('nozomi', 'free', 'himeji', 5920);
...
insert into basic_super_express_surcharge (train_type, seat_type, destination, amount) values ('hikari', 'free', 'shinosaka', 4960);
insert into basic_super_express_surcharge (train_type, seat_type, destination, amount) values ('hikari', 'free', 'himeji', 5390);
